...
class AnswerGenerator:
    ...
    def generate(
        ...
        Args:
            ...
            history: 对话历史文本（来自 SessionContext.history_text）
        ...
        history_block = ""
        if history:
            history_block = HISTORY_PREFIX.format(history_text=history) + "\n"

        prompt = RAG_PROMPT_TEMPLATE.format(
            query=query, context=context, history=history_block
        )
